...
public class EntityDrawer
{
    ...
    public void DrawBullet(BulletResponse bullet)
    {
        ...
        _spriteBatch.Draw(_bullet, texturePosition, null, Color.Red, angle, origin, scale, SpriteEffects.None, 1);
    ...
    public void DrawTank(TankResponse tank)
    {
        ...
        _spriteBatch.Draw(_body, texturePosition, null, Color.Red, tank.BodyRotation, origin, scale, SpriteEffects.None, 1);
        ...
        _spriteBatch.Draw(_turret, turretPosition, null, Color.Red, tank.BodyRotation + tank.TurretRotation, origin, scale, SpriteEffects.None, 1);
