...
namespace MonoGame.Extended
{
    ...
    public static class ShapeExtensions
    {
        ...
        /// <param name="thickness">The thickness of the lines</param>
        /// <param name="layerDepth">The depth of the layer of this shape</param>
        public static void DrawRectangle(this SpriteBatch spriteBatch, RectangleF rectangle, Color color, float rotation = 0f, Vector2? origin = null, float thickness = 1f, float layerDepth = 0)
        {
            origin ??= Vector2.Zero;
            var polygon = new Polygon(rectangle.GetCorners().Select(c => c - new Vector2(rectangle.Position.X, rectangle.Position.Y) - origin.Value));
            polygon.Rotate(rotation);

            spriteBatch.DrawPolygon(rectangle.Position, polygon, color, thickness, layerDepth);
        }
        ...
        public static void DrawLine(this SpriteBatch spriteBatch, System.Numerics.Vector2 point1, Vector2 point2, Color color, float thickness = 1f, float layerDepth = 0)
        {
            DrawLine(spriteBatch, point1.ToVector2(), point2, color, thickness, layerDepth);
        }
        ...
        public static void DrawCircle(this SpriteBatch spriteBatch, System.Numerics.Vector2 center, float radius, int sides, Color color, float thickness = 1f, float layerDepth = 0)
        {
